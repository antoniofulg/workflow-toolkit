...
model: opus
effort: high
skills: [wtk-lean, wtk-discover, wtk-plan]
---
...
- `uiux.md`, approved source/export, and `.agents/skills/wtk/references/ui-ux.md` when a screen or visual reference is in scope
...
- `.agents/skills/wtk/references/security.md` heading `## 2. At Specify — declare the surfaces` if the spec touches a surface
- `.agents/skills/wtk/references/modeling.md` if modeling a domain or boundary
- `.agents/skills/wtk/references/frontend.md` — only the heading the slice disputes, never the whole file
