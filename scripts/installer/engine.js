...
export const WORKFLOW_VERSION = '1.3.1';
...
export const LAYER_PATHS = {
  core: ['docs/toolkit/guidelines', 'docs/toolkit/README.md', 'docs/toolkit/repository-intelligence.md', 'docs/toolkit/decisions.md', 'docs/toolkit/guidelines.md', 'docs/toolkit/loop.md', 'docs/toolkit/purpose.md', 'docs/toolkit/reviews.md', 'knowledge/AGENTS.md', 'knowledge/raw/README.md', '.agents/skills/wtk', '.agents/skills/wtk-lean', '.agents/skills/wtk-discover', '.agents/skills/wtk-plan', '.agents/skills/wtk-implement', '.agents/skills/wtk-config', '.agents/skills/wtk-knowledge-check', '.agents/skills/wtk-ship', '.agents/skills/ponytail', '.agents/skills/security-audit-coordinator', '.agents/skills/security-implementation', '.agents/skills/security-review', '.agents/skills/security-spec', '.agents/skills/security-threat-model'],
...
export const CLAUDE_SKILL_LINKS = {
  core: ['wtk', 'wtk-lean', 'wtk-discover', 'wtk-plan', 'wtk-implement', 'wtk-config', 'wtk-knowledge-check', 'wtk-ship', 'ponytail', 'security-audit-coordinator', 'security-implementation', 'security-review', 'security-spec', 'security-threat-model'],
