...
evidence: docs/qa/evidence/2026-09-23-native-agent-settings/install-readback.json
...
Fresh QA at `e6002ca1` used Skills CLI 1.5.23 against an exact local source copy. Discovery and
installation returned 12 skills, independent readback resolved 85 local references, and the
installed consumer contained no WTK TOML, config skill, provider template, npm installer, or host
file mutation.
