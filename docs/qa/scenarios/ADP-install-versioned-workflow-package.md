...
Fresh QA retest at `d363b1c` confirmed the entry point now selects the same 13 skills as the README.
The earlier live install evidence remains valid because the remediation changed only documentation
and QA scenario text.
