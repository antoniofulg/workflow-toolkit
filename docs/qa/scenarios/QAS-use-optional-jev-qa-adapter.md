...
entry_points: consumer .wtk.toml; npx skills add antoniofulg/workflow-toolkit --skill wtk-qa-execute --agent '*' --copy --yes; .agents/skills/wtk-qa-execute/SKILL.md; .agents/skills/wtk-qa-execute/jev_adapter.py
qa_status: untested
bug_ids:
fix_status:
retest_status:
